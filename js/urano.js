/**
 * Sistema 3D para o planeta Urano - Versão Realista
 */
...
function initUrano() {
    console.log('🚀 Iniciando Urano 3D Realista...');
    ...
    try {
        ...
        console.log('✅ Urano 3D Realista iniciado com sucesso!');
    } catch (error) {
...
function createRealisticPlanet() {
    ...
    // Material realista inicial - cor azul-esverdeada como Urano real
    const material = new THREE.MeshLambertMaterial({
        color: 0x4fd0e3, // Azul-esverdeado característico de Urano
    ...
    loader.load(
        '../images/urano/uranus_texture.jpg',
        function(texture) {
            ...
            // Criar novo material com textura e cor azul-esverdeada realista
            const newMaterial = new THREE.MeshLambertMaterial({
                map: texture,
                color: 0xaaffff, // Azul claro para realçar textura
                emissive: 0x000000,
                transparent: false
            });
...
console.log('📄 Script Urano Realista carregado');
