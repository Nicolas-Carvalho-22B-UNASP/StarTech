/**
 * Sistema 3D para o planeta Vênus - Versão Realista
 */
...
function createRealisticPlanet() {
    ...
    // Material realista inicial - cor dourada como Vênus real
    const material = new THREE.MeshLambertMaterial({
        color: 0xffc649, // Cor dourada característica de Vênus
    ...
    loader.load(
        '../images/venus/venus_texture.jpg',
        function(texture) {
            ...
            // Criar novo material com textura e cor dourada realista
            const newMaterial = new THREE.MeshLambertMaterial({
                map: texture,
                color: 0xffcc66, // Dourado mais realista para textura
                emissive: 0x000000,
                transparent: false
            });
...
console.log('📄 Script Vênus Realista carregado');
