/**
 * Sistema 3D para o planeta Terra - Versão Realista
 */
...
function initTerra() {
    console.log('🚀 Iniciando Terra 3D Realista...');
    ...
    try {
        ...
        console.log('✅ Terra 3D Realista iniciado com sucesso!');
    } catch (error) {
...
function createRealisticPlanet() {
    ...
    // Material realista inicial - cor azul como Terra real
    const material = new THREE.MeshLambertMaterial({
        color: 0x6b93d6, // Azul característico da Terra
    ...
    loader.load(
        '../images/terra/earth_texture.jpg',
        function(texture) {
            ...
            // Criar novo material com textura e cor azul realista
            const newMaterial = new THREE.MeshLambertMaterial({
                map: texture,
                color: 0xffffff, // Branco para não alterar as cores da textura
                emissive: 0x000000,
                transparent: false
            });
...
console.log('📄 Script Terra Realista carregado');
