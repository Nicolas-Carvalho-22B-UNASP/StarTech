/**
 * Sistema 3D para o planeta Mercúrio - Versão Realista
 */
...
function initMercurio() {
    console.log('🚀 Iniciando Mercúrio 3D Realista...');
    ...
    try {
        ...
        console.log('✅ Mercúrio 3D Realista iniciado com sucesso!');
    } catch (error) {
...
function createRealisticPlanet() {
    ...
    // Material realista inicial - cor cinza como Mercúrio real
    const material = new THREE.MeshLambertMaterial({
        color: 0x4a4a4a, // Cinza escuro realista do Mercúrio
    ...
    // Inclinação axial real do Mercúrio (muito pequena)
    ...
    loader.load(
        '../images/mercurio/mercury_texture.jpg',
        function(texture) {
            ...
            // Criar novo material com textura e cor cinza realista
            const newMaterial = new THREE.MeshLambertMaterial({
                map: texture,
                color: 0x888888, // Cinza mais realista para textura
                emissive: 0x000000,
                transparent: false
            });
...
function animate() {
    ...
    // Rotação realista mais lenta do planeta
    if (isRotating && planet) {
        // Velocidade realista baseada na rotação real do Mercúrio
        planet.rotation.y += 0.002 * rotationDirection; // Muito mais lenta
    }
...
console.log('📄 Script Mercúrio Realista carregado');