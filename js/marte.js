/**
 * Sistema 3D para o planeta Marte - Versão Realista
 */
...
function initMarte() {
    console.log('🚀 Iniciando Marte 3D Realista...');
    ...
    try {
        ...
        console.log('✅ Marte 3D Realista iniciado com sucesso!');
    } catch (error) {
...
function createRealisticPlanet() {
    ...
    // Material realista inicial - cor vermelha como Marte real
    const material = new THREE.MeshLambertMaterial({
        color: 0xcd5c5c, // Vermelho característico de Marte
    ...
    loader.load(
        ...
        function(texture) {
            ...
            // Criar novo material com textura e cor vermelha realista
            const newMaterial = new THREE.MeshLambertMaterial({
                map: texture,
                color: 0xffaaaa, // Vermelho mais claro para realçar textura
                emissive: 0x000000,
                transparent: false
            });
...
console.log('📄 Script Marte Realista carregado');
